...
Inicial: 19 18.3253N,99 09.2830W (casa afuera) Desarrollado por:
...
void loop(){
 ...
 Serial.println("PROGRAMA PRIMER ARDUINO DZULUM (ROVY)- CATEGORIA ROBO MAGELLANCLUB DE ROBOTICA DE LA FACULTAD DE INGENIERIA (CROFI)");Serial.println("");
 ...
 // ============= CALIBRACIÓN GPS =============
if( calibrado == false ){
 for(int j=0;j<5;j++){ // 7 iteraciones de calibración*/
